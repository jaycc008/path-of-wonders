  ...
  const handleGoogleCallback = async (credential: string) => {
    try {
      ...
      if (response.user) {
        ...
        console.log('[SignUp] User data stored:', response.user);
      }
  ...
  useEffect(() => {
    const verifyAuth = async () => {
      ...
      try {
        ...
        if (profileData) {
          console.log('[SignUp] User authenticated via cookies, redirecting...');
        ...
        console.log('[SignUp] User not authenticated via cookies, showing signup form');
      }
    };
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all dark:bg-gray-800 dark:border-gray-700 dark:text-white ${errors.name ? 'border-red-500' : 'border-gray-300'
                          }`}
                      />
                      {errors.name && (
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all dark:bg-gray-800 dark:border-gray-700 dark:text-white ${errors.email ? 'border-red-500' : 'border-gray-300'
                          }`}
                      />
                      {errors.email && (
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          onChange={handleChange}
                          className={`w-full px-4 py-3 pr-12 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all dark:bg-gray-800 dark:border-gray-700 dark:text-white ${errors.password ? 'border-red-500' : 'border-gray-300'
                            }`}
                        />
                        <button
                          type="button"
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          onChange={handleChange}
                          className={`w-full px-4 py-3 pr-12 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all dark:bg-gray-800 dark:border-gray-700 dark:text-white ${errors.password_confirmation ? 'border-red-500' : 'border-gray-300'
                            }`}
                        />
                        <button
                          type="button"
